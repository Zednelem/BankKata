...
export class BankAccountComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.bankAccountService
      ...
      .subscribe(
        (res: HttpResponse<IBankAccount[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IBankAccount[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
