...
import { BankStatementComponent } from 'app/entities/bank-statement/bank-statement.component';
...
describe('Component Tests', () => {
  describe('BankStatement Management Component', () => {
    ...
    beforeEach(() => {
      ...
      service = fixture.debugElement.injector.get(BankStatementService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bankStatements && comp.bankStatements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
