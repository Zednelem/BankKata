...
import com.melendez.kata.domain.Authority;
...
import com.melendez.kata.service.mapper.UserMapper;
...
public class UserResourceIT {
    ...
    public static User createEntityWithDefaultLogin(EntityManager em) {
        User user = new User();
